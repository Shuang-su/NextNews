...
| 底部官方图标、菜单、帮助、时间轴 | 预览验证 | 同页复用 | 官方加载封面、全部隐藏/悬浮/横屏规则与细节 |
| 标注编号、正文、导航、关联镜头 | 10 标注预览验证 | 同源 10 标注预览验证 | 深度遮挡、热点旁浮窗、屏幕边界的完整官方行为 |
...
| 出生点、重力、跳跃、滑墙、复位 | 主机与部分真机 | 共用物理模块 | 调试可视化；坡道、台阶、窄道、墙角的完整轨迹 |
