...
| 高阶 SH | 差异 | 阻塞 | [单体 PLY/SOG SH1–3](sog-sh-20260917.md) 解析与压缩 SOG GPU 采样已接入；手机方向色/SH0 切换通过；[编码稳定页 SH](sh-pages-20260917.md) 三来源真机方向色与 SH0 切换通过，热重选零上传；浮点稳定页及同镜头 Web 完整对照未完成 |
