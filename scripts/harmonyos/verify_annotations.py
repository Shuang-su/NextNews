...
icon('关闭标注');icon('隐藏工具');hidden=snap('hotspots-hidden');assert not contains(hidden,'annotation-0')
...
(a.out/'result.json').write_text(json.dumps({'fixture':'3 Gaussian occluders, 5 world-space annotations','functionalUi':'passed','openglDepth':'available','huaweiDepth':'unverified; 2D fallback','visualReviewRequired':True,'performanceAcceptance':False},indent=2))
